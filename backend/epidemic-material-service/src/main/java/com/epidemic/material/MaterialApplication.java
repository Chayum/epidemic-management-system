...
@EnableFeignClients(basePackages = {"com.epidemic.common.feign", "com.epidemic.material.feign"})
@EnableRabbit
@EnableAsync
@MapperScan({"com.epidemic.material.mapper", "com.epidemic.common.mapper"})
