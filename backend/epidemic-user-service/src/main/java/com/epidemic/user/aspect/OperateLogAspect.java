package com.epidemic.user.aspect;
...
public class OperateLogAspect {
     ...
     */
    @Pointcut("@annotation(com.epidemic.user.annotation.OperateLog)")
    ...
    public Object around(ProceedingJoinPoint joinPoint) throws Throwable {
        ...
        try {
            ...
            // 获取注解信息
            com.epidemic.user.annotation.OperateLog annotation = getMethodAnnotation(joinPoint);
     ...
     */
    private com.epidemic.user.annotation.OperateLog getMethodAnnotation(ProceedingJoinPoint joinPoint) throws NoSuchMethodException {
        MethodSignature signature = (MethodSignature) joinPoint.getSignature();
        Method method = signature.getMethod();
        // 如果是代理类，需要获取目标类的方法
        Method currentMethod = joinPoint.getTarget().getClass()
                .getMethod(method.getName(), method.getParameterTypes());
        return currentMethod.getAnnotation(com.epidemic.user.annotation.OperateLog.class);
    }
