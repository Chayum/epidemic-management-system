...
('物资紧缺提醒', '口罩、防护服等物资库存告急，请各部门及时补充。', 'hospital_user', 'APP,SMS', 'success', '2026-02-24 10:30:00'),
('新政策发布', '关于进一步加强疫情防控工作的通知已发布，请查阅。', 'all', 'APP,WEB', 'success', '2026-02-24 09:00:00'),
('消毒物资到位', '新到一批消毒物资，已分配至各社区，请及时领取。', 'community_staff', 'APP', 'success', '2026-02-23 15:30:00'),
('核酸检测安排', '本周核酸检测安排已更新，请查看具体时间地点。', 'all', 'APP,SMS,WEB', 'success', '2026-02-23 08:00:00'),
('防疫知识科普', '如何正确佩戴口罩？疾控中心给出最新指南。', 'all', 'APP', 'success', '2026-02-22 14:00:00');
